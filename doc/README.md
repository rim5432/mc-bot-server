...
Generated: 2026-08-21. Validate anytime with `python tool/mcbot_tool.py doc check`.
...
| [overview.md](architecture/overview.md) | Architecture Overview | 2026-08-21 | ok |
...
| [workplan.md](guide/workplan.md) | Work Plan (effort-sized checklist) | 2026-08-21 | ok |
...
| [toolchain.md](reference/toolchain.md) | Toolchain Reference | 2026-08-21 | ok |

## decisions/

| Document | Title | Verified | Status |
|---|---|---|---|
| [0001-moddev-legacyforge.md](decisions/0001-moddev-legacyforge.md) | ADR-0001 Use moddev-legacyforge instead of ForgeGradle | 2026-08-21 | ok |
