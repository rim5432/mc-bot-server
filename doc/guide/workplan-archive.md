...
Immutable audit trail of shipped workplan items. Moved here from
`workplan.md` on 2026-08-27 to keep the live plan focused on OPEN
items. Entries here are not edited — corrections land as new
commits with explanation, not as rewrites of this record. For
current status and open items, see `workplan.md`.
...
### Stage 2 closeout follow-ups (RESOLVED entries)
...
## Pre-Stage-3 survival gate (SHIPPED entries)
...
- [x] M  Air-supply reflex (issue 0004 F6(2)): surface the body's
         ...
         Landed 2026-08-25 (vitals sensing pass, commit 676d957):
...
- [x] M  Idle hostile protection: today nothing engages a hostile
         ...
         survival scenario.
         Landed 2026-08-25 (idle-combat reflex, commit 4b8189a
...
## Stage 3 - player parity (SHIPPED phases)
...
### Lean-round deferrals (SHIPPED entry)
