...
| reflex bypass | reflex never enters arbiter NUMERICS (ADR-0003). Reflex-OWNED missions compete through normal register / requestControl - ledger 24-27, the ReflexSeat mechanism. | "defend / rescue missions erode boundary C" - no: the numbers stay out; the seats are the recorded mechanism. |
