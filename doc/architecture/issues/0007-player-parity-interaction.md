...
2. **Phase 2 (L)** menu system + crafting-table disclosure - api
   ...
   Post-review hardening 2026-08-25 (0f37bb7, c6a02ac; 33/33
   ...
   Vocabulary + surface round 2026-08-26 (c50368d, 8c60d76,
   e71582f, 6225227; 36/36 gametests; user rulings):
   ...
   Closeout 2026-08-26 (808e214, 2a12285, 67aad09, 11d1b7e;
...
- **Armor index order (ruled 2026-08-25, amended 2026-08-26, now
  ...
  (binding = 75 - vanillaFlat, armor only, in the four flat-index
  accessors; c50368d, pinned by equipsArmorThroughMenuClicks).
