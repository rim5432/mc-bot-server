 ...
 * without knowing tags exist. Shapeless recipes have no fixed cells
 * and are not representable here — the catalog simply never emits
 * them.
 *
...
public record RecipeView(
     ...
     *
     * @return true when every occupied cell sits in the top-left 2x2
     */
