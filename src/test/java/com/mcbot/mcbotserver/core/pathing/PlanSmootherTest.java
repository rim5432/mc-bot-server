...
class PlanSmootherTest {
    ...
    void straightRunCollapsesToEndpoints() {
        List<CellPos> smoothed = PlanSmoother.smooth(floor(4, 1),
            plan(new CellPos(0, 64, 0), new CellPos(1, 64, 0),
                new CellPos(2, 64, 0), new CellPos(3, 64, 0),
                new CellPos(4, 64, 0)));
        assertEquals(List.of(new CellPos(0, 64, 0),
            new CellPos(4, 64, 0)), smoothed);
    }
    ...
    void uniformStaircaseCollapsesToEndpoints() {
        List<CellPos> smoothed = PlanSmoother.smooth(floor(3, 1),
            plan(new CellPos(0, 64, 0), new CellPos(1, 65, 0),
                new CellPos(2, 66, 0), new CellPos(3, 67, 0)));
        assertEquals(List.of(new CellPos(0, 64, 0),
            new CellPos(3, 67, 0)), smoothed);
    }
    ...
    void zigzagCornersMergeOverClearGround() {
        List<CellPos> smoothed = PlanSmoother.smooth(floor(5, 2),
            plan(new CellPos(0, 64, 0), new CellPos(1, 64, 0),
                new CellPos(2, 64, 0), new CellPos(2, 64, 1),
                new CellPos(3, 64, 1), new CellPos(4, 64, 1),
                new CellPos(4, 64, 2), new CellPos(5, 64, 2)));
        assertEquals(List.of(new CellPos(0, 64, 0),
            new CellPos(5, 64, 2)), smoothed);
    }
    ...
    void wallOnDiagonalKeepsCornerWaypoint() {
        ...
        for (int x = 0; x <= 3; x++) {
            world.putBlock(new BlockSnapshot(
                new CellPos(x, 64, 1), "minecraft:smooth_stone"));
        }
        List<CellPos> smoothed = PlanSmoother.smooth(world,
            plan(new CellPos(0, 64, 0), new CellPos(1, 64, 0),
                new CellPos(2, 64, 0), new CellPos(2, 64, 1),
                new CellPos(3, 64, 1), new CellPos(4, 64, 1),
                new CellPos(4, 64, 2), new CellPos(5, 64, 2)));
        ...
        assertEquals(List.of(new CellPos(0, 64, 0),
            new CellPos(2, 64, 0), new CellPos(2, 64, 1),
            new CellPos(4, 64, 1), new CellPos(5, 64, 2)), smoothed);
    }
    ...
    void shortChainPassesThrough() {
        List<CellPos> two = plan(new CellPos(0, 64, 0),
            new CellPos(1, 64, 0));
